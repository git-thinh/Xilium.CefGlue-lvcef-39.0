    ...
    public sealed class LVCefRequestHandler : CefRequestHandler
    {
        ...
        protected override CefResourceHandler GetResourceHandler(CefBrowser browser, CefFrame frame, CefRequest request)
        {
	        ...
	        if (handler != null)
	        {
                ...
                //if (request.Url == "http://localhost:8000/js.js") {
                //    var hd = new System.Collections.Specialized.NameValueCollection();
                //    hd.Add("Location", "http://test.local/js.js");
                //    request.SetHeaderMap(hd);
                //}
